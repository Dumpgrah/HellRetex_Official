class HRW_M14EBR_Base: SVD_Base
{
	scope = 0;
	weight = 5100;
	absorbency = 0.0;
	...
	magazines[] = {"HRW_Mag_M14EBR_15Rnd","HRW_Mag_M14EBR_20Rnd"};
	magazineSwitchTime = 0.25;
	ejectType = 1;
	recoilModifier[] = {1,1,1};
	swayModifier[] = {2.3,2.3,1.3};
	simpleHiddenSelections[] = {"hide_barrel","optic_rail"};
...
class HRW_M14EBR: HRW_M14EBR_Base
{
	scope = 2;
	displayName="$STR_M14EBR0";
	descriptionShort = "$STR_M14EBR1";
	model = "H2A\HRW\Weapons\HRW_M14EBR\HRW_M14EBR.p3d";
	...
	{
		"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyMetal.rvmat",
		"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyPlastic.rvmat"
	};
	class DamageSystem
	{
		class GlobalHealth
		{
			class Health
			{
				...
				healthLevels[] = {
					...
					{0.5,{
						"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyMetal_damage.rvmat",
						"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyPlastic_damage.rvmat"
					}},
					{0.3,{
						"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyMetal_damage.rvmat",
						"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyPlastic_damage.rvmat"
					...
					{0.0,{
						"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyMetal_destruct.rvmat",
						"H2A\HRW\Weapons\HRW_M14EBR\Data\BodyPlastic_destruct.rvmat"
					}},
				};
			};
		};
