class HRW_Mag_HK417D_20Rnd: Magazine_Base 
{
	scope = 2;
	weight = 1100;
	itemSize[] = {1,2};
	count = 20;
	displayName = "$STR_HK417D_Mag0";
	descriptionShort = "$STR_HK417D_Mag1";
	...
	class DamageSystem 
	{
		class GlobalHealth 
		{
			class Health 
			{
				...
				healthLevels[] = 
				{
					{1.01,{"H2A\HRW\Weapons\HRW_HK417D\Data\Parts.rvmat"}},
					...
					{0.01,{"H2A\HRW\Weapons\HRW_HK417D\Data\Parts_destruct.rvmat"}}
				};
			};
		};
	};
