class HRW_USP_9x19_Base: CZ75_Base
{
	scope = 0;
	weight = 1900;
	absorbency = 0.0;
	...
	chamberSize = 1;
	chamberedRound = "";
	magazines[] = {"HRW_Mag_USP_9x19_15Rnd"	,"Hell_Mag_USP_9x19_15Rnd"};
...
class HRW_USP_9x19: HRW_USP_9x19_Base
{
	scope = 2;
	displayName = "$STR_USP_9x190";
	descriptionShort = "$STR_USP_9x191";
	model = "H2A\HRW\Weapons\HRW_USP_9x19\HRW_USP_9x19.p3d";
	attachments[] = {"pistolOptics","pistolMuzzle","pistolFlashlight"};
	itemSize[] = {3,2};
	class DamageSystem
	{
		class GlobalHealth
		{
			class Health
			{
				hitpoints = 220;
				healthLevels[] = {
					{1.0,{"H2A\HRW\Weapons\HRW_USP_9x19\Data\Body.rvmat"}},
					{0.7,{"H2A\HRW\Weapons\HRW_USP_9x19\Data\Body.rvmat"}},
					{0.5,{"H2A\HRW\Weapons\HRW_USP_9x19\Data\Body_damage.rvmat"}},
					{0.3,{"H2A\HRW\Weapons\HRW_USP_9x19\Data\Body_damage.rvmat"}},
					{0.0,{"H2A\HRW\Weapons\HRW_USP_9x19\Data\Body_destruct.rvmat"}}
				};
			};
		};
	};
