class HRW_KAC_PDW_Base: M4A1_Base
{
	scope = 0;
	weight = 2000;
	absorbency = 0.0;
	...
	chamberSize = 1;
	chamberedRound = "";
	chamberableFrom[] = {"Ammo_6x35"};
	magazines[] = {"HRW_Mag_KAC_PDW_30Rnd"};
...
class HRW_KAC_PDW: HRW_KAC_PDW_Base
{
	scope = 2;
	displayName = "$STR_KAC_PDW0";
	descriptionShort = "$STR_KAC_PDW1";
	model = "H2A\HRW\Weapons\HRW_KAC_PDW\HRW_KAC_PDW.p3d";
	attachments[] = {"weaponWrap","weaponOptics","weaponFlashlight","weaponMuzzleM4"};
	itemSize[] = {7,3};
	spawnDamageRange[] = {0.0,0.6};
	hiddenSelectionsTextures[] = 
	{
		"H2A\HRW\Weapons\HRW_KAC_PDW\Data\Body_co.paa",
		"H2A\HRW\Weapons\HRW_KAC_PDW\Data\Body_co.paa"
	};
	hiddenSelectionsMaterials[] = 
	{
		"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyMetal.rvmat",
		"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyPlastic.rvmat"
	};
	class Particles
	{
		class OnFire
		...
		class GlobalHealth
		{
			class Health
			{
				...
				healthLevels[] = {
					...
					{0.5,{
						"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyMetal_damage.rvmat",
						"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyPlastic_damage.rvmat"
					}},
					{0.3,{
						"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyMetal_damage.rvmat",
						"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyPlastic_damage.rvmat"
					...
					{0.0,{
						"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyMetal_destruct.rvmat",
						"H2A\HRW\Weapons\HRW_KAC_PDW\Data\BodyPlastic_destruct.rvmat"
					}}
				};
			};
		};
