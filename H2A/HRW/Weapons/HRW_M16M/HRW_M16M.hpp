class HRW_M16M_Base: M4A1_Base
{
	...
	hiddenSelections[] = {"body_metal","body_plastic","stocktube_metal"};
...
class HRW_M16M: HRW_M16M_Base
{
	scope = 2;
	displayName = "$STR_M16M0";
	descriptionShort = "$STR_M16M1";
	model = "H2A\HRW\Weapons\HRW_M16M\HRW_M16M.p3d";
	attachments[]={"weaponButtstockM4","weaponWrap","weaponOptics","weaponMuzzleM4","weaponFlashlight"};
	itemSize[] = {8,3};
	...
	{
		"H2A\HRW\Weapons\HRW_M16M\Data\BodyMetal.rvmat",
		"H2A\HRW\Weapons\HRW_M16M\Data\BodyPlastic.rvmat",
		"H2A\HRW\Weapons\HRW_M16M\Data\StockTubeMetal.rvmat",
	};
	class Particles
	{
		class OnFire
		...
		class GlobalHealth
		{
			class Health
			{
				...
				healthLevels[] = {
					...
					{0.5,{
						"H2A\HRW\Weapons\HRW_M16M\Data\BodyMetal_damage.rvmat",
						"H2A\HRW\Weapons\HRW_M16M\Data\BodyPlastic_damage.rvmat",
						"H2A\HRW\Weapons\HRW_M16M\Data\StockTubeMetal_damage.rvmat"
					}},
					{0.3,{
						"H2A\HRW\Weapons\HRW_M16M\Data\BodyMetal_damage.rvmat",
						"H2A\HRW\Weapons\HRW_M16M\Data\BodyPlastic_damage.rvmat",
					...
					{0.0,{
						"H2A\HRW\Weapons\HRW_M16M\Data\BodyMetal_destruct.rvmat",
						"H2A\HRW\Weapons\HRW_M16M\Data\BodyPlastic_destruct.rvmat",
						"H2A\HRW\Weapons\HRW_M16M\Data\StockTubeMetal_destruct.rvmat"
					}},
				};
			};
		};
