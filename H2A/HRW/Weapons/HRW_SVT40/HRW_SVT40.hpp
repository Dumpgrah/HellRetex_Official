class HRW_SVT40_Base: SVD_Base
{
	...
	magazines[]={"HRW_Mag_SVT40_10Rnd","Hell_Mag_SVT40_10Rnd"};
...
class HRW_SVT40: HRW_SVT40_Base
{
	scope = 2;
	displayName="$STR_SVT400";
	descriptionShort = "$STR_SVT401";
	model = "H2A\HRW\Weapons\HRW_SVT40\HRW_SVT40.p3d";
	attachments[]={"weaponWrap","suppressorImpro","weaponOpticsMosin"};
	itemSize[]={10,3};
	hiddenSelectionsTextures[] = {"H2A\HRW\Weapons\HRW_SVT40\Data\Body_ca.paa","H2A\HRW\Weapons\HRW_SVT40\Data\Body_ca.paa"};
