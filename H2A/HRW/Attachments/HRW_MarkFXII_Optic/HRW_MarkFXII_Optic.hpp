class HRW_MarkFXII_Optic : ItemOptics
{
	scope = 2;
	displayName = "$STR_MARKFXII_Optic0";
	descriptionShort = "$STR_MARKFXII_Optic1";
					...
					{1.0,
						{
							...
							"H2A\HRW\Attachments\HRW_MarkFXII_Optic\Data\ScopeMetal.rvmat"
						}
					},
					{0.7,
						{
					...
					{0.5,
						{
							...
							"H2A\HRW\Attachments\HRW_MarkFXII_Optic\Data\ScopeMetal_damage.rvmat"
						}
					},
					{0.3,
						{
					...
					{0.0,
						{
							...
							"H2A\HRW\Attachments\HRW_MarkFXII_Optic\Data\ScopeMetal_destruct.rvmat"
						}
					}
				};
			};
