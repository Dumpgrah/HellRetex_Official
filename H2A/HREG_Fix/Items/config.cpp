...
class cfgVehicles
{
	...
	class HREG_CleaningWipes: Inventory_Base
	{
		...
		hiddenSelectionsTextures[] = { "H2A/HREG_Fix/Items/Data/HREG_CleaningWipes_co.paa" };
	...
	class HREG_AntiRabies_Injector: Inventory_Base
	{
		...
		hiddenSelections[] = {"zbytek"};
		hiddenSelectionsTextures[] = {"\H2A\HREG_Fix\Items\Data\HREG_AntiRabies_Injector_co.paa"};
	};
};